...
//  PeevedPenguin
//
//  Created by Kadiatou Diallo on 6/27/16.
...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        ...
        let contactA:SKPhysicsBody = contact.bodyA //seal
        let contactB:SKPhysicsBody = contact.bodyB //penguin
